...
function ColorBlocks () {
  ...
  const tints = [tinyColorTint.brighten(6).toHex(), tinyColorTint.brighten(6).toHex(), tinyColorTint.brighten(6).toHex(), tinyColorTint.brighten(6).toHex()];
  const shades = [tinyColorShade.darken(6).toHex(), tinyColorShade.darken(6).toHex(), tinyColorShade.darken(6).toHex(), tinyColorShade.darken(6).toHex()];
